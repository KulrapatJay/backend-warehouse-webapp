...
const { GetSalesOrders, CreateSalesOrder, UpdateSalesOrder, DeleteSalesOrder, GetSalesOrdersById, UpdateOrderStatus} = require('../modules/controllers/staff/sales-orders');
